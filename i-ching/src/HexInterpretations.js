const Hex = [
    ...
    },
    {
        ...
        description: "This Hexagram is showing that hard work is paying off \nand you may already be experiencing some success.  Don't throw off your balance with pride.  Stay humble.",
    ...
    },
    {
        id: 37,
        title: 'The Family',
        description: 'Receiving this Hexagram is a reminder that community, family and friendship can be crucial for success.  These relationships must be approached with love, faithfulness and corectness.  See the balance that the individual supports the community and that community supports the individual.',
    ...
    },
    {
        id: 51,
        title: 'The Arousal',
        description: 'Shock.  Lightning over lightning.  This Hexagram shows that a series of shocks are going to occur until an obstruction is removed.  (Hint: The obstruction will most likely be attitude).  Do not react to the shocks, accept them and they will subside.',
